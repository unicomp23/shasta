...
if __name__ == "__main__":
    if len(sys.argv) < 3:
        print("Usage: python process_instrumentation.py <path_to_zip_file> <path_to_intermediate_json>")
        sys.exit(1)

    zip_file_path = sys.argv[1]
    intermediate_json_path = sys.argv[2]
    ...
    for pair, results in percentiles_results.items():
        # Commenting out printing of all pair stats
        # print(f"Pair {pair}:")
