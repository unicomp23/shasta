            ...
            eachMessage: async (payload: EachMessagePayload) => {
                ...
                if (message.key && message.value) {
                    try {
                        ...
                        Instrumentation.instance.getTimestamps(tagData.identifier).afterWorkerXAdd = performance.now();
                        ...
                        await this.redisClient.hset(commonRedisSnapshotKey,
                            ...
                            "seqno", snapshotSeqNo);
                        Instrumentation.instance.getTimestamps(tagData.identifier).afterWorkerHSet = performance.now();
